<template>
		<div>
		<div v-for="(item, index) in followList" :key="index" class="Card maincard maincard-isRecommend" >
			<div class="Followtext"  >
				<h2 class="Followtext-title" >
				...
				<div class="maintext is-collapsed" v-if="!flags[index]" >
					<div class="maintext-cover" v-if="item.target.thumbnail"  >
						<div class="maintext-cover-inner" ><img :src="item.target.thumbnail">
						</div>
							</div>
						<div class="maintext-inner">
						<span class="RichText ztext CopyrightRichText-richText" itemprop="text">
							 {{ item.target.author.name }}:{{ item.target.excerpt.substring(0,68) }}
						
						
						
							<span class="read-more link" @click="change(index)">
								<span class="Button Followtext-more Button--plain" type="button" style="color: #175199;" >阅读全文
								
								<span style="display: inline-flex; align-items: center;">
								 ​<svg xmlns="http://www.w3.org/2000/svg" class="Zi Zi--ArrowDown Followtext-arrowIcon" fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
			...
			<ul class="Followtext-actions" :class="{ active: flags[index] }">
			...
			<svg xmlns="http://www.w3.org/2000/svg" class="Zi Zi--TriangleDown" fill="currentColor" viewBox="0 0 24 24" width="10" height="10">
										...
										19 c 0.355 0.571 0.87 1.143 1.784 1.143 s 1.429 -0.572 1.784
										 ...
										 <button class="Button Followtext-action Button--plain Button--withIcon Button--withLabel" type="button">
										 							<span style="display: inline-flex; align-items: center;">​
				...
				<li class="Button Followtext-action Button--plain Button--withIcon Button--withLabel">
					<span style="display: inline-flex; align-items: center;">​
				...
				<button  class="Button Followtext-action Followtext-rightButton Button--plain" @click="change(index)" v-if="flags[index]">
					<span class="maintext-collapsedText">收起</span>
				<span style="display: inline-flex; align-items: center;">​
				<svg xmlns="http://www.w3.org/2000/svg" class="Zi Zi--ArrowDown Followtext-arrowIcon is-active" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path fill-rule="evenodd" d="M 12 13 L 8.285 9.218 a 0.758 0.758 0 0 0 -1.064 0 a 0.738 0.738 0 0 0 0 1.052 l 4.249 4.512 a 0.758 0.758 0 0 0
...
<style>
	...
	.main-left :not(.Topstory-tabCard).Card {
		margin-bottom: 0px;
		-webkit-box-shadow: none;
		box-shadow: none;
	...
	:not(.maintext--unescapable).maintext.is-collapsed .CopyrightRichText-richText {
		white-space: normal;
	}
